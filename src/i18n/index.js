...
const messages = {
  en: {
    ...
    home: {
      ...
      list_1: 'Gregory Herczeg, Luis C. Ho, Linhua Jiang, Zhuo Li, Xue-Bing Wu (Chair), Huawei Zhang', 
      bannerText: [
    ...
    schedule: {
      ...
      content: [
        ...
        'Each topic will include lectures from leading experts in the field.  Confirmed speakers include Jingxiu Wang (Sun), Zhanwen Han (Stars), Zhen Cao and Zigao Dai (High Energy Astrophysics), Shengcai Shi and Di Li (Radio Astronomy), Yipeng Jing and Luis Ho (Galaxies and Cosmology), Ruobing Dong (Planets), Chao Liu (Milky Way). These lectures will be followed by oral presentations and posters of graduate students.'
      ],
